...
export default function HoldingsTable({ holdings, page = 1, pageSize = 6, onPageChange = () => {} }) {
  ...
  const pageHoldings = holdings.slice(start, start + pageSize)
  ...
  return (
    <>
      ...
      <TablePagination page={safePage} pageSize={pageSize} totalItems={holdings.length} onPageChange={onPageChange} />
    </>
  )
}
